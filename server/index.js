...
// import cors from "cors"; // CORS для разрешения междоменных запросов
// import http from "http"; // Встроенный модуль для создания HTTP сервера
// import { Server as SocketIOServer } from "socket.io"; // Библиотека для работы с WebSockets
// import xss from "xss-clean"; // Модуль для защиты от XSS-атак

// import apiRoutes from "../routes/api.js"; // Маршруты API для обработки HTTP-запросов
// import { connectDB } from "../config/db.js"; // Подключение к базе данных
// import socketHandlers from "../utils/socketHandlers.js"; // Обработчики событий для WebSocket-соединений

// // Определение типа для ENV переменных
...
// const app: Application = express(); // Создание экземпляра Express-приложения
// const server: http.Server = http.createServer(app); // Создание HTTP-сервера на основе Express-приложения
